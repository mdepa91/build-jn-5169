...
RUN apt update && apt install -y build-essential gcc-11 clang clang-tools cmake cppcheck valgrind afl gcc-multilib git wget libfl2 && rm -rf /var/lib/apt/lists/*
